...
from ophyd.areadetector.base import ADBase, ad_group
from ophyd.areadetector.base import ADComponent as ADCpt
from ophyd.areadetector.base import EpicsSignalWithRBV as SignalWithRBV
from ophyd.areadetector.plugins import PluginBase
from ophyd.areadetector.trigger_mixins import ADTriggerStatus, TriggerBase
...
class StatsPluginV33(PluginBase):
    ...
    centroid = DDC(
        ad_group(EpicsSignalRO, (("x", "CentroidX_RBV"), ("y", "CentroidY_RBV"))),
        doc="The centroid XY",
    ...
    cursor = DDC(
        ad_group(SignalWithRBV, (("x", "CursorX"), ("y", "CursorY"))),
        doc="The cursor XY",
        default_read_attrs=("x", "y"),
    )
    ...
    max_size = DDC(
        ad_group(EpicsSignal, (("x", "MaxSizeX"), ("y", "MaxSizeY"))),
    ...
    max_xy = DDC(
        ad_group(EpicsSignalRO, (("x", "MaxX_RBV"), ("y", "MaxY_RBV"))),
        doc="Maximum in XY",
        default_read_attrs=("x", "y"),
    )
    ...
    min_xy = DDC(
        ad_group(EpicsSignalRO, (("x", "MinX_RBV"), ("y", "MinY_RBV"))),
        doc="Minimum in XY",
        default_read_attrs=("x", "y"),
    )
    ...
    profile_average = DDC(
        ad_group(
            EpicsSignalRO, (("x", "ProfileAverageX_RBV"), ("y", "ProfileAverageY_RBV"))
        ),
    ...
    profile_cursor = DDC(
        ad_group(
            EpicsSignalRO, (("x", "ProfileCursorX_RBV"), ("y", "ProfileCursorY_RBV"))
        ),
    ...
    ts_centroid = DDC(
        ad_group(EpicsSignal, (("x", "TS:TSCentroidX"), ("y", "TS:TSCentroidY"))),
    ...
    ts_max = DDC(
        ad_group(EpicsSignal, (("x", "TS:TSMaxX"), ("y", "TS:TSMaxY"))),
    ...
    ts_min = DDC(
        ad_group(EpicsSignal, (("x", "TS:TSMinX"), ("y", "TS:TSMinY"))),
